...
import {BellFilled,CrownTwoTone
...
export default function Navbar() {
  ...
  useEffect(()=>{
    // console.log('refux state changed for navbar',user)
  },[user])
  useEffect(()=>{
  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-2">
         <li onClick={()=>{navigateTo('/dashboard/default')}}>
         ...
         <li onClick={()=>{navigateTo('/dashboard/analytics')}}>
            <a  class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
    ...
    <nav class="bg-white border-gray-200 px-1 sm:px-4 py-2.5 rounded dark:bg-gray-900">
      <div class="container flex flex-wrap items-center">
        ...
        <span style={{position:'absolute',right:20,top:5}}> <BellFilled /></span>
