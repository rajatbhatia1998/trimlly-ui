...
export default function CreateUrl() {
  ...
  {configs.membership.planType=='FREE' &&  <CrownTwoTone style={{marginRight:5}} twoToneColor='#FFD700'/>}
    ...
    <input disabled={configs.membership.planType=='FREE' ? true:false} type="text" id="slug" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Custom Slug" required/>
  </div>
  <div class="mb-6">
  ...
  <div class="flex items-start mb-6">
    ...
    {configs.membership.planType=='FREE' &&  <CrownTwoTone style={{marginRight:5}} twoToneColor='#FFD700'/>}
      <input disabled={true} id="passwordProtected" type="checkbox" value="" class="w-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800" required/>
    </div>
