...
export default function Dashboard() {
  ...
  const toggleSidebar  = ()=>{
    const menu = document.getElementById("drawer-navigation")
...
{!showDrawer && <div onClick={()=>{toggleSidebar()}} className='drawerBGTransaparent'></div>}
<nav class="bg-white border-gray-200 px-1 sm:px-4 py-2.5 rounded dark:bg-gray-900">
  ...
  <div class="flex items-center md:order-2">
      ...
      <Avatar style={{ backgroundColor: '#f56a00' ,textTransform:'uppercase'}}>{user.email[0]}</Avatar>}
      </button>
...
<div id="drawer-navigation" class="hidden fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-navigation-label">
      ...
      <ul class="space-y-2">
         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  ...
                  <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
            </button>
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Custom</a>
                  </li>
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Bio Links</a>
                  </li>
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-base font-normal text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Secure</a>
                  </li>
            </ul>
         </li>
         <li>
  ...
  <div className=''>
      {currentMenu==='DASHBOARD' && <DashboardDefault/>}
  </div>
    </div>
  )
}
